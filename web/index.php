...
$serviceContainer = Nucleus\Framework\Nucleus::factory(__DIR__ . '/../src/Nucleus/Framework/nucleus.json')->getServiceContainer();
$debugbar = $serviceContainer->getServiceByName("debugBar");
$debugbarRenderer = $serviceContainer->getServiceByName("debugBarRenderer");

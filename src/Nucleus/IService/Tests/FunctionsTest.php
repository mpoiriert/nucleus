...
class FunctionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function functionCallback($a,$b)
    {
        return $a - $b;
    }
    
    public function functionCallbackA($a,$b) 
    {
        return $a['a'] - $b['a'];
    }
    
    public function functionCallbackB($a,$b) 
    {
        return $a['b'] - $b['b'];
    }
    
    public function functionCallbackC($a,$b) 
    {
        return $a['c'] - $b['c'];
    }
    ...
    {
        return array(
            array(array(4, 5, 3, 6, 2, 1, 7), array(array($this,'functionCallback')), array(1, 2, 3, 4, 5, 6, 7)),
            array(
                array(array('a' => 1, 'b' => 2), array('a' => 1, 'b' => 1), array('a' => 2, 'b' => 2), array('a' => 2, 'b' => 1)),
                array(array($this,'functionCallbackA'), array($this,'functionCallbackB')),
            ...
            array(
                ...
                array(array($this,'functionCallbackA'), array($this,'functionCallbackB'),array($this,'functionCallbackC')),
